...
top_row <- plot_grid(meth,kmer.plot,genes.plot,sd.plot,pro.plot,map.plot,rm.plot,censat.plot,ncol = 1, align="v",rel_heights = c(1/6, 1/6,1/6,1/6,1/6,1/40,1/25,1/15))
top_row
ggsave(
