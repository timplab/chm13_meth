...
top_row <- plot_grid(meth,cov.plot,kmer.plot,pro.plot,map.plot,censat.plot,ncol = 1, align="v",rel_heights = c(1/6, 1/6,1/6,1/6,1/25,1/10))
top_row
ggsave(
  paste0(figs, "/methyl_profiles/", chrom,"_PanelPlot.pdf"),
  plot = top_row,
  scale = 1,
  width = 10,
  height = 3
