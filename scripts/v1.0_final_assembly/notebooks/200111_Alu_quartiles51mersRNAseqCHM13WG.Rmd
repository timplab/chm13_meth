...
r1 <- read_tsv(paste0(dat, "/TE/rm_v2.0/chrX-PARremoved_chm13_k51_single-mrg_meryl.over.CHM13_1_S182_RNAseq_cutadapt-m100_bt2-N0-k100_chm13-20200922_COV_RM.bed"), col_names = c("chr", "start", "end", "len", "comp", "rep_type", "rep_fam", "col8", "col9", "col10", "col11", "SW", "perc_sub", "del", "ins", "cov", "num_depth", "len", "per_cov")) 
...
ggsave(
  paste0(figs, "/evol_meth/TE/","Alu_all_quartiles_meta_byname51merschm13chrXWG.pdf"),
  plot = p,
  scale = 1,
  width = 10,
  height = 5,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartilesBar51merchm13chrXWG.pdf"),
  plot = p1,
  scale = 1,
  width = 5,
  height = 5,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartiles_ggridges51merchm13chrXWG.pdf"),
  plot = violin,
  scale = 1,
  width = 10,
  height = 10,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartiles_cov_violin51merchm13chrXWG.pdf"),
  plot = violin,
  scale = 1,
  width = 10,
  height = 10,
