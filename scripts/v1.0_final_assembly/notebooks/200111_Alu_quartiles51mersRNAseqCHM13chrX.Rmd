...
ggsave(
  paste0(figs, "/evol_meth/TE/","Alu_all_quartiles_meta_byname51merschm13chrX.pdf"),
  plot = p,
  scale = 1,
  width = 10,
  height = 5,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartilesBar51merchm13chrX.pdf"),
  plot = p1,
  scale = 1,
  width = 5,
  height = 5,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartiles_ggridges51merchm13chrX.pdf"),
  plot = violin,
  scale = 1,
  width = 10,
  height = 10,
...
ggsave(
  paste0(figs, "/evol_meth/TE/Alu_quartiles_cov_violin51merchm13chrX.pdf"),
  plot = violin,
  scale = 1,
  width = 10,
  height = 10,
