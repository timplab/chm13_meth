...
write.table(chm13.ovl, file = paste0(dat, "/sd/HG002_toCHM13_SD_clustered_methylationPerBase.bed"),quote = F, sep = "\t", row.names = F, col.names = T)
...
write.table(final_clust, file = paste0(dat, "/sd/HG002_toCHM13_SD_clustered_methylation.bed"),quote = F, sep = "\t", row.names = F, col.names = T)

ggsave(
  paste0(figs, "/","HG002_toCHM13_SD_methylation_heatmap.pdf"),
  plot = res,
  scale = 1,
  width = 10,
  height = 10,
