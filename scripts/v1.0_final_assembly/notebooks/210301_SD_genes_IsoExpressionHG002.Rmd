...
write.table(df, file =paste0(dat, "/sd/sd.HG002_V2_transcripts.10kb_methAG.bed"),  quote = F, sep = "\t",row.names = F,
            col.names = T)
...
write.table(chm13.ovl.labs, file =paste0(dat, "/sd/sd.HG002_V2_transcripts.10kb_methAGForPlot.bed"),  quote = F, sep = "\t",row.names = F,
            col.names = T)
