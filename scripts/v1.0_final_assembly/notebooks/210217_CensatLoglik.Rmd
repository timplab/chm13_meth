...
calls <- read_tsv(paste0(dat, "/methylation_calls/repeat_intersect/50kb_methylationCalls_censatV2Intersect.bed"), col_names = F)
...
```{r}
list <- c("BSAT", "HOR", "DHOR", "MON", "CT", "HSAT1", "HSAT2", "HSAT3", "HSAT4", "HSAT5", "HSAT6", "GSAT")
sub <- calls %>%
  filter(X10 %in% list)
