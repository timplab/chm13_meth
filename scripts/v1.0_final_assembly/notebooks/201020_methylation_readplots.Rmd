...
region_start=123000000
region_end= 123100000
reg = cgcalls %>%
...
smooth.list <- lapply(calls.list,smoothCalls, bandwidth = 80)
...
ggplot(runs_plot, aes(x =lengths, fill = m, alpha = .5))+geom_density()+xlim(0,5000)
