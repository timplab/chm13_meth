...
#38800000       39000000
region_start=38550000
region_end= 38550000+40000
reg = cgcalls %>%
...
reads <- tabix_mbed(paste0(dat, "/censat/", "chr4sst1.mbed"),extcol = "motif",by = "read") 
#chrX:48,626,035-49,040,073
...
#38800000       39000000
region_start=135040000
region_end= 135080000
reg = cgcalls %>%
  dplyr::filter(start >= region_start) %>%
  dplyr::filter(end <= region_end)
