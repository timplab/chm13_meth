...
cov=read_tsv(paste0(dat, "/HG002_nanonome_1-3_merge_chrX.bedgraph"), col_names = F)
...
p <- ggplot(cov.average, aes( x = window.start, y = coverage))+geom_smooth(method = "loess", span = 0.01,se = F)+ylim(0,50)
p
```
