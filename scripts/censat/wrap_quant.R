...
opt$coords="/uru/Data/Nanopore/Analysis/gmoney/chm13/censat/phase_2/censat_chr1_annotations.tsv"
...
for (i in 1: length(coords$hicanu_ctg)){
  ...
  rmarkdown::render("/home/gmoney/chm13_meth/scripts/censat/censat_meth_quant.rmd",
